...
| G1 — Install trust | `84940b0a-51fe-4fc8-8f4e-cfb8a9b99a0c` | 0% (6 issues) |
| G2 — Pro commerce | `4071fbe3-5f04-4ad1-a4b9-14a689ba300d` | 0% |
| G3 — Product polish | `d12e2fda-8612-4c92-aa35-f8eb0072c815` | 0% |
| G4 — Growth | `7942f808-5cf9-420a-beeb-0a6d3ad608dc` | 25% (RON-375 Done) |

## G1 — Install trust (next up)

| ID | Issue | State · Priority |
|----|-------|------------------|
| RON-359 | G1-01 Enroll Apple Developer Program ($99) | Todo · Urgent |
| RON-360 | G1-02 Developer ID Application cert + signed Mac build | Todo · Urgent |
| RON-361 | G1-03 Notarize Mac release zip | Todo · Urgent |
| RON-362 | G1-04 Windows code signing or document SmartScreen | Todo · High |
| RON-363 | G1-05 Clean-machine install smoke from Releases (Mac + Win) — **blocked by RON-379** | Todo · Urgent |
| RON-379 | G1-06 Publish clutterdock repo + release assets (regressed by rebrand) | Todo · Urgent |
...
| ID | Issue | State |
|----|-------|-------|
| RON-352…358, RON-378 | G0-01 … G0-08 (foundation: apps, site+domains live, CI, updates, releases) | Done |
...
| RON-372 | G3-04 Direct asset download links on site — **blocked by RON-379** | Todo · Low |
| RON-373 | G3-05 Terms of use for Pro license | Todo · Low |
| RON-374 | G4-01 Soft launch posts — **blocked by RON-363** | Todo · High |
| RON-375 | G4-02 Rebrand decision — **Done: ClutterDock chosen & shipped** | Done |
